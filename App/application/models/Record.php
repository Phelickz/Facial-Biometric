...
return $query->result_array();
  ...
  public function TotalBio_OP($status)
  {
...
///calculate Api
  public function ApiCall($trans_type)
  {
...
$data = $this->DisplayAllNum_('in_store',$userID_data,'in_store_id');
return $data; 
  }
...
public function DAYBio_OP($status)
  {
...
//Graphic Daily Display
    ...
    public function GraphicBio_OP($status,$days)
  {
...
return $data; 
    ...
    public function BGraphicMonthly($status)
  {
