...
<head>
    ...
    <title>AWS Unified User Interface</title>

	<link href="<?=base_url(); ?>assets/appmart/css/uui.css" rel="stylesheet" />
</head>
<body>
    <header class="header">
	...
	<form id="Bio_data_enrol" action="<?php echo base_url(); ?>service/api/push/image_call_upload" method="POST" name="Bio_data_enrol">
        ...
        <section class="navigation">
            <a id="uuicancel" href=""><img src="<?=base_url(); ?>assets/appmart/images/abort.svg" class="button-grow" alt="abort" title="Abort and navigate back to caller" data-res="buttonCancel" /></a>
            <a id="uuimirror" href="#" class="hidden"><img src="<?=base_url(); ?>assets/appmart/images/mirror.svg" class="button-grow" alt="mirror" title="Mirror the display of the captured images" data-res="buttonMirror" /></a>
        </section>
        ...
        <section id="uuiwebapp" class="webapp">
            ...
            <a id="uuistart" class="startbutton" href="#"><img src="<?=base_url(); ?>assets/appmart/images/play.svg" class="button-big-grow" alt="start" title="Start the recording of images" data-res="buttonStart" /></a>
    ...
    <script src="<?=base_url(); ?>assets/appmart/js/jquery-3.3.1.min.js"></script>
    <script src="<?=base_url(); ?>assets/appmart/js/getUserMedia.min.js"></script>
    <script src="<?=base_url(); ?>assets/appmart/js/bws.capture.js"></script>
    <script src="<?=base_url(); ?>assets/appmart/js/three.min.js"></script>
    <script src="<?=base_url(); ?>assets/appmart/js/objLoader.min.js"></script>
	<script src="<?= base_url(); ?>assets/appmart/js/appconfig.js"></script>
    ...
    <script type="text/javascript">
        ...
        localStorage.setItem("EtokenApi", token );
        ...
        function initHead() {
            ...
            loader.load( my_url+'assets/appmart/model/head.php', function (head) {
