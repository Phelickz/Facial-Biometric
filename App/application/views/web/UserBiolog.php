                                    ...
                                    <div class=" col s1">
                                     ...
                                     <div class=" col s2">
                                       ...
                                       <select  class="form-control form_k waves-effect waves-light" ng-model="status" ng-change="show_data()">
                                         ...
                                         <option value="2">Mutiple Identify</option>
                                       </select>              
                                    </div>
                                    ...
                                    <div class="card-content">
                                        <div class="">
                                         <code>   <table  id="" class="table table-bordered table-striped table-hover">
                                               ...
                                               <td><img src='https://aws.appmartgroup.com/upload/<?=$this->session->userdata("partition_id")?>{{x.classID}}1.png'  alt="" width="50" height="50" ></td>             
...
$scope.show_data = function() {
   $scope.loader=5;
  $scope.loading="PLEASE WAIT WHILE DATA IS LOADING"; 
$http.post("<?=base_url()?>Report/getUserBioLog",{
   'status':$scope.status,
})
