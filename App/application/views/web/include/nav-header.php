<nav class="navbar navbar-inverse navbar-fixed-top">
                ...
                <a class="navbar-brand pull-left" href="" >
                   <img src="http://appmartgroup.com/images/Appmart.png" alt="" width="180" height="60">
                </a>
                <a id="menu-toggle">
                    ...
                    <ul class="navbar navbar-right">
                        ...
                        <li class="dropdown">
                            <a class='dropdown-button user-pro' href='#' data-activates='dropdown-user'>
                                <img src="<?= base_url() ?>assets/web/dist/img/avatar5.png" class="img-circle" height="45" width="50" alt="User Image">
                            </a>
